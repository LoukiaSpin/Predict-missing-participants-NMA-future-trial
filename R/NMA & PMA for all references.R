...
tiff("./Figure S2.tiff", 
     ...
     compression = "lzw", 
     res = 600)
ggarrange(base_mod[[2]]$figure + ggtitle("LABA") + theme(title = element_text(face = "bold")), 
          base_mod[[3]]$figure + ggtitle("ICS") + theme(title = element_text(face = "bold")), 
          base_mod[[4]]$figure + ggtitle("ICS+LABA") + theme(title = element_text(face = "bold")), 
          base_mod[[5]]$figure + ggtitle("tiotropium") + theme(title = element_text(face = "bold")),
          common.legend = TRUE, 
          legend = "bottom", 
          labels = c("a)", "b)", "c)", "d)"))
dev.off()
